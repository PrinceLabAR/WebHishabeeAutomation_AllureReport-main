...
public class TestCase extends DriverSetup{
	...
	public void loginTest() throws InterruptedException {
		...
		Thread.sleep(5000);
		WebHomePage.InsertNumber("01706668222");
	...
	public void ContactAdd() throws InterruptedException {
		...
		WebContactPage.A_Name("Prince Roy");
		WebContactPage.A_Number("01706668222");
		WebContactPage.A_Email("prince.roy.bauet@gmail.com");
		WebContactPage.A_Address("BD, Gazipur");
...
@Test
	public void ContactUpDate() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebContactPage.U_Name("Prince Kumar Roy");
		WebContactPage.U_Number("019706668000");
		WebContactPage.U_Email("Prince@gmail.com");
		WebContactPage.U_Address("Mirpur");
